...
| - | - |
| --- | --- |
| After evaluating all the models, we select the one that performs best and obtain some cross-validated classification metrics. Finally we study the Feature Importance to see which ones contribute more to the model. | <img align="right" width="1000" height="400" src="/images/model_results_2.png?raw=true"/> |
<br>
